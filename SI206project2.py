...
def main():
    ...
    total += test(grab_headlines(),["'Jane the Virgin' becomes Adam the Virgo in season 4 shift", 'Orion Sang: Michigan should see what it has with Peters', 'Students attempt to shut down speech by controversial social scientist Charles Murray ',  "'Lil Pump' delivers hype despite a lack of substance", "Breakdown: Michigan vs. Indiana"] ,50)
